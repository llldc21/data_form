...
CREATE TABLE IF NOT EXISTS `llldc21_data_form`.`TB_FORMULARIO` (
  ...
  INDEX `fk_TB_FORMULARIO_TB_USUARIO_idx` (`ID_USUARIO` ASC) VISIBLE,
  INDEX `fk_TB_FORMULARIO_TB_CATEGORIA1_idx` (`ID_CATEGORIA` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `llldc21_data_form`.`TB_PERGUNTA` (
  ...
  INDEX `fk_TB_PERGUNTA_TB_TIPO_PERGUNTA1_idx` (`ID_TIPO_PERGUNTA` ASC) VISIBLE,
  INDEX `fk_TB_PERGUNTA_TB_FORMULARIO1_idx` (`ID_FORMULARIO` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `llldc21_data_form`.`TB_ALTERNATIVA` (
  ...
  INDEX `fk_TB_ALTERNATIVA_TB_PERGUNTA1_idx` (`ID_PERGUNTA` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `llldc21_data_form`.`TB_RESPOSTA` (
  ...
  INDEX `fk_TB_RESPOSTA_TB_ALTERNATIVA1_idx` (`ID_ALTERNATIVA` ASC) VISIBLE,
